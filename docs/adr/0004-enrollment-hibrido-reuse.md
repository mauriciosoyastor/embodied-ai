...
- **Consecuencias:** preserva `win32`/`mypy strict`/`uv` + `12/12` ingeniería, evita dependencias pesadas y licencias non-commercial, requiere mantener `docs/agents/research/028|029` como evidencia y `CONTEXT.md:89` glosario híbrido.
